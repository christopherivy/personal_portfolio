...
import "./about.css";
// import AboutImg from "../../assets/about.jpg"; // old
// import CV from "../../assets/Smith-Cv.pdf";// old
import AboutImg from "../../assets/chris_profile.jpg";
import CV from "../../assets/Ivy-resume.pdf";
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p className="about__description">
            As a Military Veteran with 8 years of honorable service from 2007 to 2015, I transitioned into the field of Software Engineering after being drawn to technology. I thrive in team environments where we can collaborate and solve problems
            together, and I am constantly striving to improve my skills as a Developer.
          </p>
